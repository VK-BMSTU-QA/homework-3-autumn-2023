...
* Настройки. При клике на раздел "Общие" произойдет переход на страницу с настройками аккаунта.
* Настройки. При клике на раздел "Уведомления" произойдет переход на страницу с уведомлениями.
* Настройки. При клике на раздел "Права доступа" произойдет переход на страницу с подключением доступа.
* Настройки. При клике на раздел "История изменений" произойдет переход на страницу с историей изменений в кабинете.
...
* Бюджет. При клике на кнопку "пополнить счет" 
...
* Центр коммерции. При клике на кнопку "создать каталог" в правой части экрана появляется попап, где можно создать новый каталог
