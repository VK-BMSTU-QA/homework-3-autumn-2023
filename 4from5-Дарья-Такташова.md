...
- Кампании. Форма создания кампании. Настройки кампании. При нажатии на "Целевые действия" доступно для выбора одно из целевых действий: "Сайт", "Каталог товаров", "Мобильное приложение", "Сообщество и профиль", "Одноклассники", "Лид-формы", "VK Mini Apps", "Музыка", "Видео и трансляции", "Дзен".
...
- Кампании. Форма создания кампании. Настройки кампании. При нажатии на "Узнаваемость и охват" можно выбрать один из форматов: "Баннерная реклама", "Видеореклама", "Запись ВКонтакте", "Статья и Дзен"
...
- Кампании. Форма создания кампании. Группы объявлений. Интересы и поведение. Ключевые фразы. При вводе ключевой фразы появляется кнопка "показать 10 похожих", где 10 - кол-во найденных фраз по ключевой фразе реклама
...
- Кампании. Форма создания кампании. Объявления. Медиафайлы. При загрузке изображения больше, чем 600 * 600, оно появится на вкладке "Предпросмотр", отобразится в разделе "Изображения" в двух форматах 1:1, 16:9, и в разделе "Видео" в формате 16:9
