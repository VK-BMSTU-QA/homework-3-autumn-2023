...
- Кампании. Форма создания кампании. Настройки кампании. Узнаваемость и охват. Можно выбрать один из форматов; "Баннерная реклама", "Видеореклама", "Запись ВКонтакте", "Статья и Дзен"
...
- Кампании. Фильтр. Сохранённые. Доступен список сохранённых фильтров
