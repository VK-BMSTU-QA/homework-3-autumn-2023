...
- Центр коммерции. Модальное окно открытия доступа. При нажатии на кнопку "Отмена" модально окно закрывается

- Центр коммерции. Модальное окно открытия доступа. При нажатии в любую точку области вне окна, модально окно закрывается
...
- Центр коммерции. Модальное окно настроек. Нажатие на кнопку "Удалить каталог" открывает модально окно удаления каталога
...
- Центр коммерции. Нажатие на вкладку "Товары" открывает страницу товаров

- Центр коммерции. Нажатие на вкладку "Группы" открывает страницу групп

- Центр коммерции. Нажатие на вкладку "Диагностика" открывает страницу диагностики

- Центр коммерции. Нажатие на вкладку "События" открывает страницу событий

- Центр коммерции. Нажатие на вкладку "История загрузок" открывает страницу истории загрузок
...
- Центр коммерции. Группы. Модальное окно создания с фильтрами. При нажатии на кнопку "Сохранить" с непустым значением поля "Назвение" создаётся новая группа товаров
